...
<div id="wrapper">
  ...
  <div id="content">
    <div class="left-col">
     	...
     	<h2>Добавить Pet</h2>
      	<div align="center">
      <FORM NAME="form_add_pets" id="form_add_pets" method="get" action="AddPet">
 		<p><B>Введите тип, разновидность:</B><br />
		  <input name="type" type="text" class="validate(required, username)" size="30" />
		</p>
		<p><B>Введите тип, разновидность:</B><br />
		  <input name="specias" type="text" class="validate(required, username)" size="30" />
		</p>
		<p><B>Введите окрас:</B><br />
		<INPUT TYPE="text" NAME="paint" class="validate(required, username)" SIZE=30></p>
		<P><B>Введите размер:</B><br />
		<INPUT TYPE="text" NAME="size" class="validate(required, username)" SIZE=30></P>
        <P><B>Введите средний вес:</B><br />
		<INPUT TYPE="text" NAME="aver_weight" class="validate(required, number)" SIZE=30></P>
		<P>
			<INPUT TYPE="submit" VALUE="Добавить животное" NAME="add_petButton" onclick="validate_add_pets()">
		</P>
	</FORM>
