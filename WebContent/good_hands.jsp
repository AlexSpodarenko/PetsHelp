...
<body>
<%DaoFactory.getGoodHandsDao().replenishment(); %>
...
<div id="wrapper">
  ...
  <div id="content">
    <div class="left-col">
      <h2>В добрые руки</h2>
      <div class="elem">
      	<img src="images/gallery_1.jpg" alt="animal#1" vspace="10" hspace="15" align="left"/>
        <p class="text_left_img">Йоркширский терьер. Щенок!
Щенок йоркширского терьера Продается щенок йоркширского терьера. Привит, документы, вет паспорт.
		</p>
		<p class="more"><a href="elem.jsp">more...</a></p>
      </div>
     </div>
