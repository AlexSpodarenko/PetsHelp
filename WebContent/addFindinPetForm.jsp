...
<h2>Добавить найденое животное</h2>
      	<div align="center">
      <FORM name="form_add_finding_pet" id="form_add_finding_pet" method="post" action="AddFindingPet" enctype="multipart/form-data" accept-charset="UTF-8">
		<p><B>Область:</B><br />
		...
		<div id="petSpeciesDiv" style="width:290px;"></div>
		 ...
		 <input name="where_placed" type="text" class="validate(required, username)" size="30" />
		</p>
